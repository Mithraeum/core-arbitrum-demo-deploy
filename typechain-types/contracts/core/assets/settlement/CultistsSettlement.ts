...
export interface CultistsSettlementInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addGovernor"
      | "army"
...
export interface CultistsSettlement extends BaseContract {
  connect(runner?: ContractRunner | null): CultistsSettlement;
  waitForDeployment(): Promise<this>;

  interface: CultistsSettlementInterface;
