...
export interface IFortInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "advancedProduction"
      | "basicProduction"
  ...
  encodeFunctionData(
    functionFragment: "calculateDamageDone",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export namespace HealthUpdatedEvent {
  export type InputTuple = [newHealth: BigNumberish];
  export type OutputTuple = [newHealth: bigint];
  export interface OutputObject {
    newHealth: bigint;
  }
  export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>;
...
export interface IFort extends BaseContract {
  connect(runner?: ContractRunner | null): IFort;
  waitForDeployment(): Promise<this>;

  interface: IFortInterface;
  ...
  calculateDamageDone: TypedContractMethod<
  ...
  getMaxHealthOnLevel: TypedContractMethod<
    [level: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  health: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "calculateDamageDone"
  ...
  >;
  getFunction(
    nameOrSignature: "getMaxHealthOnLevel"
  ): TypedContractMethod<[level: BigNumberish], [bigint], "view">;
  getFunction(
  ...
  filters: {
    ...
    "HealthUpdated(uint256)": TypedContractEvent<
      HealthUpdatedEvent.InputTuple,
      HealthUpdatedEvent.OutputTuple,
      HealthUpdatedEvent.OutputObject
    >;
