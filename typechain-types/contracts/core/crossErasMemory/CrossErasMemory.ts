...
export interface CrossErasMemoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addUserSettlement"
...
export interface CrossErasMemory extends BaseContract {
  connect(runner?: ContractRunner | null): CrossErasMemory;
  waitForDeployment(): Promise<this>;

  interface: CrossErasMemoryInterface;
