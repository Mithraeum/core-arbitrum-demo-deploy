...
export interface IRegionOwnershipTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IRegionOwnershipToken extends BaseContract {
  connect(runner?: ContractRunner | null): IRegionOwnershipToken;
  waitForDeployment(): Promise<this>;

  interface: IRegionOwnershipTokenInterface;
  ...
  mint: TypedContractMethod<
    [to: AddressLike, regionId: BigNumberish],
    [void],
    "nonpayable"
  >;
