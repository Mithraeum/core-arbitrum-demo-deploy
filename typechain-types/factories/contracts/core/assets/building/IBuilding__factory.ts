...
import type {
  IBuilding,
  IBuildingInterface,
} from "../../../../../contracts/core/assets/building/IBuilding";
...
export class IBuilding__factory {
  ...
  static createInterface(): IBuildingInterface {
    return new Interface(_abi) as IBuildingInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IBuilding {
    return new Contract(address, _abi, runner) as unknown as IBuilding;
  }
}
